...
let myName: string = "BAkhtawar";  //This saves the name
...
let famous_person: string = "ALbert Einsein";
...
let guests: string[] = ["Maryam", "Urooj", "Nikola Saba"];
...
let guest: string[] = ["Maryam", "Bob", " Alice", "Isaac Newton", "Ur"];
